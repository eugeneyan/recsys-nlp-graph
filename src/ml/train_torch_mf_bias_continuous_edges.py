...
if __name__ == '__main__':
    ...
    # Initialize model
    mf = MFBiasContinuous(edges.n_unique_tokens, emb_dim).to(device)
    ...
    for epoch in range(epochs):
        ...
        state_dict_path = '{}/mf_bias_continuous_edges_epoch_{}_{}.pt'.format(MODEL_PATH, epoch, current_datetime)
    ...
    results_df.to_csv('{}/model_metrics_mf_bias_continuous_edges.csv'.format(MODEL_PATH), index=False)
